...
namespace PlataformaJiujitsu.Migrations
{
    ...
    [Migration("20250610171627_FixRelacionamentoChaveInscricao")]
    partial class FixRelacionamentoChaveInscricao
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlataformaAPI.Models.Chave", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PlataformaAPI.Models.Luta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("Atleta1Id")
                        .HasColumnType("int");

                    b.Property<int>("Atleta2Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PlataformaAPI.Models.Luta", b =>
                {
                    b.HasOne("PlataformaJiujitsu.Models.Atleta", "Atleta1")
                        .WithMany()
                        .HasForeignKey("Atleta1Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PlataformaJiujitsu.Models.Atleta", "Atleta2")
                        .WithMany()
                        .HasForeignKey("Atleta2Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PlataformaAPI.Models.Chave", "Chave")
                        .WithMany("Lutas")
